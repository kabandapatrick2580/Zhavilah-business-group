...
const leftColumn: HistoryBlock[] = [
  { kind: "image", icon: "warehouse", src: "/assets/img/project/project-1.jpg", alt: "Customs Bonded Warehouse" },
  {
    kind: "card",
    icon: "lock",
  ...
  { kind: "image", icon: "boxes", src: "/assets/img/project/project-2.jpg", alt: "Warehouse Storage" },
  {
    kind: "card",
    icon: "coins",
...
const rightColumn: HistoryBlock[] = [
  ...
  { kind: "image", icon: "badge", src: "/assets/img/about/ncua-bond-rule-change.webp", alt: "Compliance Management" },
  {
    kind: "card",
    icon: "shield",
